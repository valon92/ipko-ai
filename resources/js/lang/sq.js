export default {
    ...
    registerBusiness: {
        registerTitle: "Regjistro Biznesin Tuaj",
        businessName: "Emri i Biznesit",
        businessNumber: "Numri i Biznesit",
        email: "Adresa e Email-it",
        password: "Fjalëkalimi",
        businessType: "Lloji i Biznesit",
        typeSmall: "Biznes i Vogël",
        typeMedium: "Biznes i Mesëm",
        typeEnterprise: "Biznes i Madh",
    ...
    BusinessSupport: {
      ...
      cart: {
        ...
        subtitle: "Shikoni dhe menaxhoni produktet që keni zgjedhur.",
        yourCart: "Produktet në shportë",
        remove: "Hiq nga shporta",
        empty: "Shporta juaj është bosh.",
        checkout: "Përfundo Blerjen",
        checkoutMessage: "Blerja juaj është përfunduar me sukses!",
      },
      shop: {
        ...
        pcBusinessDesc: "Kompjuterë të fuqishëm për nevojat e biznesit tuaj.",
        cashRegister: "Arka Fiskale",
        cashRegisterDesc: "Pajisje të certifikuara për menaxhimin e transaksioneve.",
        networking: "Pajisje për Rrjet",
        networkingDesc: "Routera dhe switch-e për rrjetin e biznesit tuaj.",
      },
    ...
    contact: {
        title: "Na Kontaktoni",
        subtitle: "Ne do të dëshironim të dëgjonim nga ju.",
        email: "Email",
        phone: "Telefon",
        address: "Adresa",
        ...
        send: "Dërgo Mesazh",
        successMessage: "Mesazhi juaj u dërgua me sukses!",
    },
    faq: {
        title: "Pyetjet më të Shpeshta",
        subtitle: "Gjeni përgjigje për pyetjet më të zakonshme.",
        heading: "Pyetjet e Zakonshme",
        q1: "Çfarë shërbimesh ofron IPKO.ai?",
        a1: "IPKO.ai ofron konsulencë AI, mjete automatizimi dhe analiza të të dhënave.",
        q2: "Si mund të kontaktoj mbështetjen?",
        a2: "Na kontaktoni përmes email-it në support@ipko.ai.",
        q3: "A ofroni provë falas?",
        a3: "Po, ofrojmë një provë falas 14-ditore për shërbimet premium.",
        ctaTitle: "Keni ende pyetje?",
        ctaDescription: "Mos hezitoni të na kontaktoni direkt!",
        ctaButton: "Na Kontaktoni",
    },
};
